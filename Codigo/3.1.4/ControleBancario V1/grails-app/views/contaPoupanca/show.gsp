...
<html>
    ...
    <body>
        ...
        <div id="show-contaPoupanca" class="content scaffold-show" role="main">
            ...
            <f:display bean="contaPoupanca" />
            <g:form resource="${this.contaPoupanca}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.contaPoupanca}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
