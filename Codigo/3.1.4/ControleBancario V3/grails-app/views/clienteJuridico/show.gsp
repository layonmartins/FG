...
<html>
    ...
    <body>
        ...
        <div id="show-clienteJuridico" class="content scaffold-show" role="main">
            ...
            <f:display bean="clienteJuridico" />
            <g:form resource="${this.clienteJuridico}" method="DELETE">
                <fieldset class="buttons">
                    <sec:access controller="clienteJuridico" action='create'>
                        <g:link class="edit" action="edit" resource="${this.clienteJuridico}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
                    </sec:access>
