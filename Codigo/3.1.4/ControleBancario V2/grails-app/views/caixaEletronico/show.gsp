...
<html>
    ...
    <body>
        ...
        <div id="show-caixaEletronico" class="content scaffold-show" role="main">
            ...
            <f:display bean="caixaEletronico" />
            <g:form resource="${this.caixaEletronico}" method="DELETE">
                <fieldset class="buttons">
                    <sec:access controller="caixaEletronico" action='create'>
                        <g:link class="edit" action="edit" resource="${this.caixaEletronico}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
                    </sec:access>
                    <sec:access controller="caixaEletronico" action='delete'>
