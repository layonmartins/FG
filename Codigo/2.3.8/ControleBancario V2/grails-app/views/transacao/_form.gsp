...
<div class="fieldcontain ${hasErrors(bean: transacaoInstance, field: 'caixaEletronico', 'error')} ">
	...
	<g:select id="caixaEletronico" name="caixaEletronico.id" from="${br.ufscar.dc.dsw.CaixaEletronico.list()}" optionKey="id" value="${transacaoInstance?.caixaEletronico?.id}" class="many-to-one"/>
</div>
