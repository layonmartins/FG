...
class CaixaEletronicoController {
    ...
    def save(CaixaEletronico caixaEletronicoInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'caixaEletronicoInstance.label', default: 'CaixaEletronico'), caixaEletronicoInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'caixaEletronicoInstance.label', default: 'CaixaEletronico'), params.id])
                redirect action: "index", method: "GET"
            }
