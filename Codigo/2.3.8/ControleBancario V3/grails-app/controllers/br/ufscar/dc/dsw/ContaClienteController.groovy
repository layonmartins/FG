...
class ContaClienteController {
    ...
    def edit(ContaCliente contaClienteInstance) {
        ...
        if (contaClienteInstance != null && contaClienteInstance.conta.agencia.id != session.agencia.id) {
            flash.message = message(code: 'springSecurity.denied.message', args: [message(code: 'transacaoInstance.label', default: 'Transacao'), contaClienteInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'contaClienteInstance.label', default: 'ContaCliente'), params.id])
                redirect action: "index", method: "GET"
            }
