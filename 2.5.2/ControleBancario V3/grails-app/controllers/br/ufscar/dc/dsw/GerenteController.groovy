...
class GerenteController {
    ...
    def save(Gerente gerenteInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'gerenteInstance.label', default: 'Gerente'), gerenteInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'gerenteInstance.label', default: 'Gerente'), params.id])
                redirect action: "index", method: "GET"
            }
