...
class ContaPoupancaController {
    ...
    def index(Integer max) {
        ...
        respond results, model:[contaPoupancaInstanceCount: ContaPoupanca.count()]
    }
    ...
    def edit(ContaPoupanca contaPoupancaInstance) {
        ...
        if (contaPoupancaInstance != null && contaPoupancaInstance.agencia.id != session.agencia.id) {
            flash.message = message(code: 'springSecurity.denied.message', args: [message(code: 'transacaoInstance.label', default: 'Transacao'), contaPoupancaInstance.id])
