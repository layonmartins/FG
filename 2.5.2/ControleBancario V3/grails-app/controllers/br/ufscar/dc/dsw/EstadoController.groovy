...
class EstadoController {
    ...
    def save(Estado estadoInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'estadoInstance.label', default: 'Estado'), estadoInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'estadoInstance.label', default: 'Estado'), params.id])
                redirect action: "index", method: "GET"
            }
