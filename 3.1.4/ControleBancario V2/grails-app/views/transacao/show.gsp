...
<html>
    ...
    <body>
        ...
        <div id="show-transacao" class="content scaffold-show" role="main">
            ...
            <f:display bean="transacao" />
            <g:form resource="${this.transacao}" method="DELETE">
                <fieldset class="buttons">
                    <sec:access controller="transacao" action='create'>
                        <g:link class="edit" action="edit" resource="${this.transacao}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
                    </sec:access>
