...
<html>
    ...
    <body>
        ...
        <div id="show-faixa" class="content scaffold-show" role="main">
            ...
            <f:display bean="faixa" />
            <g:form resource="${this.faixa}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.faixa}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
