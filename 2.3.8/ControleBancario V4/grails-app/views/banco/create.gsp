...
<html>
    ...
    <body>
        <a href="#create-banco" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
                       ...
                       <h1><g:message code="default.create.label" args="[entityName]" /></h1>
                        ...
                        <g:hasErrors bean="${bancoInstance}">
                            <ul class="errors" role="alert">
                                ...
                                <g:form class="pure-form pure-form-aligned" url="[resource:bancoInstance, action:'save']" >
                                    <fieldset class="form">
