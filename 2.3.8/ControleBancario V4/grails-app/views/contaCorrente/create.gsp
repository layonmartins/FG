...
<html>
    ...
    <body>
        <a href="#create-contaCorrente" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
                       ...
                       <h1><g:message code="default.create.label" args="[entityName]" /></h1>
                        ...
                        <g:hasErrors bean="${contaCorrenteInstance}">
                            <ul class="errors" role="alert">
                                ...
                                <g:form class="pure-form pure-form-aligned" url="[resource:contaCorrenteInstance, action:'save']" >
                                    <fieldset class="form">
